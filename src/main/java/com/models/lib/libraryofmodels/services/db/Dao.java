...
public class Dao<T> {
    ...
    public T get(String key) {
    	List<T> entities = get(Collections.singletonList(key));
    ...
    // TODO: Not a big deal but, this could be somewhere else, in DbWhereClause for example
